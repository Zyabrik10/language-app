import { Dictionary, ModalWindow } from "../classes";
// Words import
...
export default async function initVars(localStorageName, lang) {
  ...
  vars.lang = lang;
  vars.wordExtraInfoModal = (new ModalWindow('word-extra-info')).init();
  vars.editingWordModal = (new ModalWindow('edit-word')).init();
  vars.langs = {
    en: "English",
    pl: "Polish",
  };
