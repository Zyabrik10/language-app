...
function initWordsTrainingElements() {
    (0, _globalVariables.elements).trainWords = {
...
function initWritingTrainingElements() {
    (0, _globalVariables.elements).writingTraining = {
...
function initWordExtraInfoModal() {
    (0, _globalVariables.elements).wordExtraInfoModal = {
...
function initDictionary() {
    (0, _globalVariables.elements).dictionary = {
...
// Words import
var _enJson = require("../../dictionary/en.json");
var _enJsonDefault = parcelHelpers.interopDefault(_enJson);
var _plJson = require("../../dictionary/pl.json");
...
function initVars(localStorageName, lang) {
    ...
    (0, _globalVariables.vars).dictionary = new (0, _classes.Dictionary)(words[lang]);
    (0, _globalVariables.vars).storage = new (0, _classes.LocalStorage)(localStorageName);
    (0, _globalVariables.vars).wordExtraInfoModal = new (0, _classes.ModalWindow)('.word-extra-info-modal', '.close-button');
    ...
    // init favorite words
    (0, _globalVariables.vars).dictionary.setFavorites(true, ...(0, _globalVariables.vars).storage.getItem() || []);
    // fill vars.elements.dictionary.filters
    (0, _globalVariables.vars).dictionary.types.forEach((type, index)=>{
        for(const key_type in (0, _globalVariables.vars).filters)(0, _globalVariables.vars).filters[key_type][type] = {
            used: false,
            expression: (0, _globalVariables.vars).dictionary.types_expression[index]
        };
    });
}

},{"../classes":"kxt4J","../../dictionary/en.json":"kz8Kt","../../dictionary/pl.json":"6cJ5K","../utils":"9UsVm","../globalVariables":"irTVF","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kxt4J":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "ModalWindow", ()=>(0, _modalWindowDefault.default));
...
},{"./LocalStorage":"lVDZ7","./Dictionary":"ctwsM","./ModalWindow":"jLufe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lVDZ7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class LocalStorage {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jLufe":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class ModalWindow {
...
parcelHelpers.export(exports, "renderDictionary", ()=>(0, _renderDictionaryDefault.default));
...
var _renderDictionary = require("./renderDictionary");
var _renderDictionaryDefault = parcelHelpers.interopDefault(_renderDictionary);
var _prompts = require("./prompts");
parcelHelpers.exportAll(_prompts, exports);

},{"./throttle":"8Uc4U","./parseWords":"2juJg","./renderDictionary":"elIqO","./prompts":"83lAT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8Uc4U":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"elIqO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>renderDictionary);
var _globalVariablesJs = require("../globalVariables.js");
var _wordJs = require("../components/Word.js");
...
function getResembledWords(searchTerm) {
    ...
    let filteredWords = [
        ...new Set(partsArray.map((part)=>{
            const wordsByPart = (0, _globalVariablesJs.vars).dictionary.getWordsByPart(part.trimLeft());
            const typedWords = (0, _globalVariablesJs.vars).dictionary.getWordsByTypes(wordsByPart, ...Object.keys((0, _globalVariablesJs.vars).filters.dictionary).map((key)=>(0, _globalVariablesJs.vars).filters.dictionary[key].used && `${key}`));
            let favFiltered = typedWords.length !== 0 ? typedWords : (0, _globalVariablesJs.vars).dictionary.getFavorites();
            if (!(0, _globalVariablesJs.vars).filters.dictionary.favorite.used) favFiltered = favFiltered.filter(({ favorite })=>!favorite);
            return favFiltered;
        }).flat())
    ];
...
function renderDictionary(searchTerm = "") {
    ...
    const sortedWords = (0, _globalVariablesJs.vars).dictionary.getSorted(wordsByPart);
    (0, _globalVariablesJs.elements).dictionary.listElement.innerHTML = "";
    const lis = sortedWords.map((word, index)=>{
        const li = document.createElement("li");
        li.appendChild((0, _wordJsDefault.default)(word, index + 1));
        return li;
    });
    lis.forEach((li)=>(0, _globalVariablesJs.elements).dictionary.listElement.appendChild(li));
    (0, _globalVariablesJs.elements).wordsCountEl.innerHTML = sortedWords.length;
}

},{"../globalVariables.js":"irTVF","../components/Word.js":"ehU1J","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ehU1J":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function WordComponent(word, index = 0, callback = ()=>{}) {
    ...
    const isFavorite = (0, _globalVariables.vars).dictionary.getById(id).favorite;
    if (isFavorite) {
...
},{"../globalVariables":"irTVF","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"83lAT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function setEvents() {
    ...
    (0, _globalVariablesJs.elements).wordExtraInfoModal.addFavoriteWordButton.addEventListener("click", addWordToFavorite);
    // ========== Input which searches for words ==========
    (0, _globalVariablesJs.elements).dictionary.searchInput.addEventListener("input", (0, _utils.throttle)(searchWords, 100));
    // ========== Form train writing text ==========
    (0, _globalVariablesJs.elements).writingTraining.textForm.addEventListener("submit", getAITextReview);
    ...
    (0, _globalVariablesJs.elements).writingTraining.textTextArea.addEventListener("input", countWordsOnTyping);
    // ========== Button which generate text example for a word ==========
    (0, _globalVariablesJs.elements).wordExtraInfoModal.aiTextGenerationButton.addEventListener("click", ({ currentTarget })=>{
        const { expression, type } = (0, _globalVariablesJs.vars).dictionary.getById(currentTarget.dataset.id);
        const prompt = (0, _utils.wordsExamplesPrompt)(expression, type, (0, _globalVariablesJs.vars).langs[(0, _globalVariablesJs.vars).lang]);
        (0, _globalVariablesJs.elements).wordExtraInfoModal.aiGeneratedText.innerHTML = "Loading...";
        (0, _globalVariablesJs.elements).wordExtraInfoModal.aiTextGenerationButton.disabled = true;
        askAI(prompt).then((response)=>{
            (0, _globalVariablesJs.elements).wordExtraInfoModal.aiGeneratedText.innerHTML = response.message.content;
            (0, _globalVariablesJs.elements).wordExtraInfoModal.aiTextGenerationButton.disabled = false;
        });
    });
}
function addWordToFavorite() {
    const id = (0, _globalVariablesJs.elements).wordExtraInfoModal.addFavoriteWordButton.dataset.wordId;
    const isFavoriteWord = (0, _globalVariablesJs.vars).dictionary.getById(id).favorite;
    if (!isFavoriteWord) {
        (0, _globalVariablesJs.vars).dictionary.setFavoriteById(id, true);
        (0, _globalVariablesJs.vars).storage.setItem([
            ...(0, _globalVariablesJs.vars).storage.getItem() || [],
            id
        ]);
        (0, _globalVariablesJs.elements).wordExtraInfoModal.addFavoriteWordButton.innerHTML = "Remove from Favorite";
    } else {
        (0, _globalVariablesJs.vars).dictionary.setFavoriteById(id, false);
        (0, _globalVariablesJs.vars).storage.setItem((0, _globalVariablesJs.vars).storage.getItem().filter(({ fId })=>id === fId));
        (0, _globalVariablesJs.elements).wordExtraInfoModal.addFavoriteWordButton.innerHTML = "Add to Favorite";
    }
    (0, _utils.renderDictionary)();
}
function searchWords(event) {
    const searchTerm = event.target.value;
    (0, _utils.renderDictionary)(searchTerm);
}
function getAITextReview(event) {
    event.preventDefault();
    const text = (0, _globalVariablesJs.elements).writingTraining.textForm.train_writing_text_textarea.value;
    const prompt = (0, _utils.aiWritingReviewPrompt)(text, (0, _globalVariablesJs.vars).langs[(0, _globalVariablesJs.vars).lang]);
    (0, _globalVariablesJs.elements).writingTraining.textAiReview.innerHTML = "Loading...";
    (0, _globalVariablesJs.elements).writingTraining.textForm.submit.disabled = true;
    askAI(prompt).then((response)=>{
        (0, _globalVariablesJs.elements).writingTraining.textAiReview.innerHTML = response.message.content;
        (0, _globalVariablesJs.elements).writingTraining.textForm.submit.disabled = false;
    });
}
function countWordsOnTyping() {
    (0, _globalVariablesJs.elements).writingTraining.textTotalWords.innerText = (0, _globalVariablesJs.elements).writingTraining.textTextArea.value.trim().split(" ").length;
}
...
function initWordExtraInfo(word) {
    const isFavoriteWord = (0, _globalVariablesJs.vars).dictionary.getById(word.id).favorite;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.aiTextGenerationButton.dataset.id = word.id;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.addFavoriteWordButton.dataset.wordId = word.id;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.addFavoriteWordButton.innerText = !isFavoriteWord ? "Add to Favorite" : "Remove from Favorite";
    (0, _globalVariablesJs.elements).wordExtraInfoModal.word.innerText = word.expression;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.type.innerText = word.type;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.type.classList.add(word.type);
    (0, _globalVariablesJs.elements).wordExtraInfoModal.wordId.innerText = word.id;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.translation.innerText = word.translation;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.description.innerText = word.description;
    (0, _globalVariablesJs.elements).wordExtraInfoModal.aiGeneratedText.innerHTML = "";
}
function handleGlobalViewportClicking(event) {
    if (event.target.closest(".word-button")) {
        ...
        const word = (0, _globalVariablesJs.vars).dictionary.getById(id);
        (0, _globalVariablesJs.vars).wordExtraInfoModal.showModalWindow(initWordExtraInfo.bind(null, word));
...
function main() {
    // === rendering filters ===
    (0, _globalVariablesJs.elements).dictionary.filters.innerHTML = "";
    (0, _globalVariablesJs.elements).trainWords.filtersElement.innerHTML = "";
    (0, _globalVariablesJs.elements).dictionary.filters.appendChild((0, _indexJs1.Filter)((0, _globalVariablesJs.vars).filters.dictionary, ()=>(0, _utils.renderDictionary)((0, _globalVariablesJs.elements).dictionary.searchInput.value)));
    (0, _globalVariablesJs.elements).trainWords.filtersElement.appendChild((0, _indexJs1.Filter)((0, _globalVariablesJs.vars).filters.trainWords, ()=>(0, _indexJs.initTrainWords)()));
...
},{"./globalVariables.js":"irTVF","./programs/index.js":"7TBPS","./components/index.js":"fGXnV","./utils":"9UsVm","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7TBPS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function foo(word) {
    (0, _globalVariables.elements).trainWords.randomWordElement.innerHTML = "";
    (0, _globalVariables.elements).trainWords.randomWordElement.appendChild((0, _components.Word)(word));
}
function initTrainWords() {
    const typedWords = (0, _globalVariables.vars).dictionary.getWordsByTypes((0, _globalVariables.vars).dictionary.d, ...Object.keys((0, _globalVariables.vars).filters.trainWords).map((key)=>(0, _globalVariables.vars).filters.trainWords[key] && `${key}`));
    filteredWords = typedWords.length !== 0 ? typedWords : (0, _globalVariables.vars).dictionary.getFavorites();
    ...
    if (filteredWords.length > 0) {
        ...
        (0, _globalVariables.elements).trainWords.wordsElement.innerHTML = filteredWords.length;
        (0, _globalVariables.elements).trainWords.currentIndexElement.innerHTML = currentWordIndex + 1;
        foo(filteredWords[currentWordIndex]);
    } else {
        (0, _globalVariables.elements).trainWords.wordsElement.innerHTML = 0;
        (0, _globalVariables.elements).trainWords.currentIndexElement.innerHTML = 0;
        (0, _globalVariables.elements).trainWords.randomWordElement.innerHTML = "No words found";
    }
}
...
},{"../utils":"9UsVm","../globalVariables":"irTVF","../components":"fGXnV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fGXnV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Word", ()=>(0, _wordDefault.default));
...
},{"./Word":"ehU1J","./Filter":"4IL0u","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4IL0u":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
